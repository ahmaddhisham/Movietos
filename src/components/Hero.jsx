  ...
  return (
    <section className="relative mb-24 mt-0 h-[85vh] min-h-[600px] overflow-hidden rounded-b-3xl shadow-2xl">
      ...
      <div className="absolute inset-0 mt-0">
        ...
        <div className={`absolute inset-0 bg-gradient-to-br from-gray-900 to-gray-800 transition-opacity duration-700 ${
        ...
        <div className="max-w-4xl">
          ...
          <div className="mb-6 flex flex-wrap items-center gap-4">
            <div className="flex items-center gap-2">
              <div className={`flex items-center gap-1 rounded-full bg-gradient-to-r ${getRatingColor(movie.vote_average)} px-4 py-2 font-semibold text-white`}>
            ...
            {movie.vote_count && (
              <div className="flex items-center gap-2 rounded-full bg-black/40 px-4 py-2 backdrop-blur-sm">
                ...
                <span className="text-sm text-gray-300">{movie.vote_count.toLocaleString()} votes</span>
              </div>
            )}
          </div>
          ...
          <div className="flex flex-wrap gap-4">
            <button className="group flex items-center gap-3 rounded-full bg-white px-8 py-4 font-semibold text-black transition-all hover:bg-gray-200 hover:scale-105 active:scale-95">
              <Play className="h-5 w-5 transition-transform group-hover:scale-110" />
              <span>Watch Trailer</span>
            </button>
            
            <button className="group flex items-center gap-3 rounded-full border border-white/30 bg-black/40 px-8 py-4 font-semibold text-white backdrop-blur-sm transition-all hover:bg-black/60 hover:border-white/50">
